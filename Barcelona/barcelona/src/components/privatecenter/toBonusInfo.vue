  ...
  <div class="container">
    ...
    <div class="bread-crumb">
      <Breadcrumb>
        ...
        <BreadcrumbItem to="/PrivateCenter/toBonus">
          <Icon size="24" type="ios-ribbon-outline"></Icon>
          中奖记录
        </BreadcrumbItem>
      </Breadcrumb>
    </div>
    <div class="layout">
      <Layout>
        <Sider ref="side1" hide-trigger collapsible :collapsed-width="78" v-model="isCollapsed">
          <Menu active-name="1-5" theme="dark" width="auto" :class="menuitemClasses">
            <MenuItem name="1-1">
          ...
          <Content :style="{margin: '1px', background: '#fff', minHeight: '525'}">
            <Row :gutter="0" style="margin-top: 0px;">
              <i-col :md="24" :lg="24" style="margin-bottom: 0px;">
                <Card shadow>
                  <div>
                    <Table class="bonus-table" border :columns="columns" :data="bonusList" size="large"
                           no-data-text="你还有中奖记录，快点去投注吧"></Table>
                    <div class="page-size">
      ...
      bonusList: [
        {
          ...
          stateid: '20190101001',
          gamblesno: 4,
          gamblesimg: 'static/img/index/DICE-230.png',
          gamblesnum: 15,
          stateinfo: '【中奖规则】：1赔3',
          statebonus: 4,
          statebonusimg: 'static/img/index/DICE-230.png',
        ...
        },
        {
          ...
          stateinfo: '【中奖规则】：1赔3',
          statebonus: 3,
          statebonusimg: 'static/img/index/DICE-430.png',
