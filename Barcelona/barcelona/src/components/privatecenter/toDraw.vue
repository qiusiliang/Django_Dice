  ...
  <div class="container">
    ...
    <div class="bread-crumb">
      <Breadcrumb>
        ...
        <BreadcrumbItem to="/PrivateCenter/toDraw">
          <Icon size="24" type="ios-cash-outline"></Icon>
          我要取款
        </BreadcrumbItem>
      </Breadcrumb>
    </div>
      ...
      <Layout>
        ...
        <Layout>
          ...
          <Content :style="{margin: '1px', background: '#fff', minHeight: '360px'}">
            <Row :gutter="20" style="margin-top: 0px;" v-for="(item, index) in drawdata.detail" :key="index">
...
export default {
  ...
  computed: {
    ...
    ...mapState(['countdowns', 'userInfo', 'drawdata'])
  },
  methods: {
    collapsedSider () {
      this.$refs.side1.toggleCollapse()
    },
    ...mapActions(['loadGambleInfo', 'LoadDrawInfo'])
  },
  components: {
    countTo,
    LobbyNav4,
