    ...
    <footer class="footer">
      ...
      <div class="icon-row">
        <div class="footer-icon">
          ...
          <span class="footer-icon-text">购彩指南，加入会员</span>
        </div>
        <div class="footer-icon">
          <h5 class="footer-icon-child footer-icon-child-2"></h5>
          <span class="footer-icon-text">下注方式，多重组合</span>
        </div>
        <div class="footer-icon">
          <h5 class="footer-icon-child footer-icon-child-3"></h5>
          <span class="footer-icon-text">极速返现，客户服务</span>
        </div>
        <div class="footer-icon">
          <h5 class="footer-icon-child footer-icon-child-4"></h5>
          <span class="footer-icon-text">信用服务，品质保障</span>
        </div>
      </div>
      <div class="service-intro">
        ...
        <div class="clearfix"></div>
        <div class="copyright">
          <p>Copyright © 2018 by QingZhuang <a href="">
            <Icon type="social-usd-outline"></Icon>
          </a> <span>澳门庆壮-快五博彩</span></p>
        </div>
      </div>
    </footer>
  </div>
...
export default {
  ...
  data () {
    return {
      ...
      guideArr: [
        ['购彩指南', 'A.购彩流程', 'B.会员介绍', 'C.充值方式', 'D.联系客服'],
        ['下注方式', 'A.单点下注', 'B.单双下注', 'C.大小下注', 'D.组合下注'],
        ['极速返现', 'A.返现流程', 'B.微信返现', 'C.支付宝返现', 'D.银联返现'],
        ['信用服务', 'A.售后政策', 'B.价格保护', 'C.退款说明', 'D.取消订单']
      ],
      moreLink: [
        '关于我们', '联系我们', '联系客服', '合作招商', '商家帮助', '营销中心', '销售联盟', '博彩社区', '风险监测', '隐私政策'
      ]
    }
  }
}
